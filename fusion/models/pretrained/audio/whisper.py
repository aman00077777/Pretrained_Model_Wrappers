...
class WhisperEncoder(BaseEncoder):
    """Wraps a Hugging Face Whisper model as a FUSION audio encoder."""
    ...
    def from_pretrained(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            **kwargs: Forwarded to WhisperModel.from_pretrained.

        Returns:
            An initialized WhisperEncoder.
        """
    ...
    def encode(
        ...
        if not isinstance(inputs, torch.Tensor):
            raise TypeError(
                f"WhisperEncoder expects a torch.Tensor, got {type(inputs)}"
            )
        ...
        # Whisper's processor converts raw waveforms into log-Mel
        # spectrogram features expected by the encoder.
        ...
        # Use ONLY the Whisper encoder.
        # The decoder is not required for obtaining audio embeddings.
        ...
        # Mean-pool the temporal sequence into one embedding per
        # audio sample.
