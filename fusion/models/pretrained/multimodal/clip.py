...
Defines CLIPWrapper: wraps HuggingFace's CLIP model
(openai/clip-vit-base-patch32) as a FUSION multimodal encoder.

Follows the BaseEncoder pattern:
...
class CLIPWrapper(BaseEncoder):
    ...
    def encode_image(
        ...
        """Encode one or more PIL images into CLIP vision embeddings.
    ...
    def encode_text(
        ...
        """Encode one or more strings into CLIP text embeddings.
